...
public class ConfigmapInjectionSource implements InjectionSource {
    private static final Pattern PATH = Pattern.compile("^//(?<namespace>[^/]+)/(?<name>[^/]+)/(?<key>[^/]+)$");

    private final String namespace;
    private final String name;
    private V1ConfigMap values;

    public ConfigmapInjectionSource(String path) {
    ...
    public void resolve() throws IOException {
        ...
        try {
            values = api.readNamespacedConfigMap(name, namespace, null, null, null);
    ...
    public boolean equals(Object o) {
        ...
        ConfigmapInjectionSource that = (ConfigmapInjectionSource) o;
